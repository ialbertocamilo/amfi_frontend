        ...
        <div className="w-full max-w-md bg-white p-4 rounded">
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-black mb-2" htmlFor="password">Vuelve a ingresar la nueva contraseña</label>
                <input className="w-full px-3 py-2 border rounded" type="password2" id="password2" name="password2" value={formData.password} onChange={handleChange} />
              </div>
              <button type="submit" className="w-full bg-red-500 text-white py-2 rounded">Cambiar contraseña</button>
            </form>
          )}
        </div>
      </div>
