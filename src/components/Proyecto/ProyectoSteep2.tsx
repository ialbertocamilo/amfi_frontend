      ...
      <form >
        <div className="mb-8 bg-white shadow-md rounded m-4 p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              <label htmlFor="temporalidad" className="block text-sm font-medium text-gray-700">Temporalidad</label>
              <select
                id="temporalidad"
                name="temporalidad"
                className="mt-1 block w-full p-2 border border-gray-300 rounded-md"
            ...
            <div>
              <label htmlFor="desglose" className="block text-sm font-medium text-gray-700">Desglose</label>
              <input
                type="text"
                id="desglose"
                name="desglose"
            ...
            <div>
              <label htmlFor="territorio" className="block text-sm font-medium text-gray-700">Territorio</label>
              <select
                id="territorio"
                name="territorio"
                className="mt-1 block w-full p-2 border border-gray-300 rounded-md"
            ...
            <div>
              <label htmlFor="derechos" className="block text-sm font-medium text-gray-700">Derechos</label>
              <input
                type="text"
                id="derechos"
                name="derechos"
            ...
            <div>
              <label htmlFor="formaCotizacion" className="block text-sm font-medium text-gray-700">Forma Cotizacion</label>
              <select
                id="formaCotizacion"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-8 mb-8">
              <div>
                <label htmlFor="entregaBrief" className="block text-sm font-medium text-gray-700">Entrega de Brief</label>
                <input
                  type="date"
                  id="entregaBrief"
                  name="entregaBrief"
              ...
              <div>
                <label htmlFor="entregaPresupuesto" className="block text-sm font-medium text-gray-700">Entrega presupuesto y TT</label>
                <input
                  type="date"
              ...
              <div>
                <label htmlFor="visualizacion" className="block text-sm font-medium text-gray-700">Visualización</label>
                <input
                  type="date"
                  id="visualizacion"
                  name="visualizacion"
              ...
              <div>
                <label htmlFor="entregaProyecto" className="block text-sm font-medium text-gray-700">Entrega proyecto</label>
                <input
                  type="date"
                  id="entregaProyecto"
          ...
          <div className="flex justify-center space-x-4">
            <button type="button" className="w-1/4 bg-white text-red-500 border border-red-500 py-2 rounded" onClick={() => handleSubmit('1')}>Atras</button>
            <button type="button" className="w-1/4 bg-red-500 text-white py-2 rounded" onClick={() => handleSubmit('3')}>Siguiente</button>
          </div>
        </div>
      </form>
    </div>
