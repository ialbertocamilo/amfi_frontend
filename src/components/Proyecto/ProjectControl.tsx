...
export const ProjectControl: React.FC = () => {
    ...
    const handleStatusChange = useCallback(async (newStatus: ProjectStatus) => {
        try {
            ...
            const project = await updateProjectStatus(memoizedProject.id, newStatus);
                                    ...
                                    <div className="p-4 rounded-lg bg-gray-50/5">
                                        <div className="space-y-2 text-xs text-gray-500 font-mono">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <span>STATUS:</span>
                                                <ProjectStatusText status={project?.status as ProjectStatus} />
                                            </div>
                                            <div className="space-y-2 text-xs text-gray-500 font-mono">
                                                <div className="flex justify-between">
                                    ...
                                    <div className="p-4 rounded-lg bg-gray-50/5">
                                        <div className="space-y-2 text-xs text-gray-500 font-mono">
                                            <div className="flex justify-between">
                                                ...
                                                <span>{formatToLocalTime(project?.updatedAt?.toLocaleString() as string)}</span>
                                            </div>
                                            <div className="space-y-2 text-xs text-gray-500 font-mono">
                                                <div className="flex justify-between">
